        ...
        <div class="container">
            <div class="row">
                <div class="col l6 s12">
                    <h5 class="white-text"><img class="footer-logo" src="../img/logo.png"></h5>
                </div>
                <div class="col l4 offset-l2 s12">
                    <h5 class="white-text">Наши контакты</h5>
                    <ul>
                        <li><a class="grey-text text-lighten-3" href="#!">+375 29 225 01 57</a></li>
                        <li><a class="grey-text text-lighten-3" href="#!">Минск</a></li>
                        <li><a class="grey-text text-lighten-3" href="#!">Цнянская 21</a></li>
                    </ul>
                </div>
            </div>
        </div>
